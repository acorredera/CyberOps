...
if __name__ == "__main__":
    ...
    consumer_NoiseLevel = consumer.Consumer(topic=topic, field2Extract=field2Extract, DAO=dao, ip_kafka_DCOS=settings.ip_kafka_DCOS)
    consumer_NoiseLevel.run()
