...
clf1 = joblib.load(PATH+'/SVC_own_dataset_Classifier_py35.pkl')
clf2 = joblib.load(PATH+'/RF_own_dataset_Classifier_py35.pkl')
clf3 = joblib.load(PATH+'/ET_own_dataset_Classifier_py35.pkl')
clf4 = joblib.load(PATH+'/GB_own_dataset_Classifier_py35.pkl')
clf5 = joblib.load(PATH+'/DT_own_dataset_Classifier_py35.pkl')
clf6 = joblib.load(PATH+'/BC_own_dataset_Classifier_py35.pkl')
...
def get_files(emotion):  # Define function to get file list, randomly shuffle it and split 80/20
    files = glob.glob("/home/marta/PycharmProjects/CYBEROPS/RECONOCIMIENTO_FACIAL/BANCO_IMAGENES/IMAGENES_PROPIAS/CascadeClassifier/%s/*" % emotion)
...
from sklearn.externals import joblib
joblib.dump(clf7, PATH+'/MLP_own_dataset_prediction_Classifier_py35.pkl') #Save classifier