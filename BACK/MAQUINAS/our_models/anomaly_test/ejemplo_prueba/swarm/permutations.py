...
'/usr/local/lib/python2.7/dist-packages/nupic/swarming/exp_generator/experiment_generator.pyc'
"""
...
permutations = {
  ...
  u'value': PermuteEncoder(maxval=900000000, fieldName='value', w=21, clipInput=True, minval=0.0, encoderClass='ScalarEncoder', n=PermuteInt(22, 521), ),
      },
    },
