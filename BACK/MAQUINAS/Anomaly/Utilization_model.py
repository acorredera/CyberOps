...
# Utilizacion ---> /home/marta/PycharmProjects/CYBEROPS/MAQUINAS/Labeled_data/ec2_cpu_utilization_5f5533_labeled.csv
...
# _TRAINING_DATA_FILE = "/home/marta/PycharmProjects/CYBEROPS/MAQUINAS/Labeled_data/ec2_cpu_utilization_5f5533_labeled (copia).csv"
_INPUT_DATA_FILE = "utilization_train.csv"
new_data = ["2019-04-24 14:22:00", 45]
...
_OUTPUT_PATH = "anomaly_scores_utilization.csv"
        ...
        for i, record in enumerate(reader, start=1):
            ...
            if i == lines:
                if anomalyLikelyhood2 > _ANOMALY_THRESHOLD:
                    _LOGGER.info("Anomaly detected at [%s]. Anomaly score: %f.", result.rawInput["c0"],
                                 anomalyScore)
                    anomaly = 1
                else:
                    anomaly = 0
