...
def get_files(emotion):  # Define function to get file list, randomly shuffle it and split 80/20
    files = glob.glob("/home/marta/PycharmProjects/untitled/pyAudioAnalysis/dataset/%s/*" % emotion)
    ...
    for emotion in emotions:
        ...
        for item in training:
            ...
            if data['landmarks_vectorised'] == "error":
                ...
                training_data.append(data['landmarks_vectorised'])  # List of landmarks results for the image, appended image array to training data list
...
from sklearn.externals import joblib
joblib.dump(clf7, '/home/marta/PycharmProjects/untitled/pyAudioAnalysis/MLP_prediction_Classifier.pkl') #Save classifier